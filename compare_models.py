...
from utils.modules import DPAC
from holonet import *
...
p.add_argument('--gen_type', type=int, default=0, help='CNN:0,DPAC:1,Propagation:2')
...
with torch.no_grad():
    for k, target in enumerate(val_loader):
        ...
        with torch.no_grad():
            writer.add_scalar('Image_No', psnr_value, ik)
            if ik >=99:
