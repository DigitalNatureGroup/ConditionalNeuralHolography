...
class ImageLoader:
    ...
    def __init__(self, data_path,out_list=[],channel=None, batch_size=1,
        ...
        self.im_names = self.get_image_filenames(data_path)
        self.im_names.sort()
    ...
    def get_image_filenames(self,dir):
        ...
        images = [os.path.join(dir, f)
                ...
                if e[1:] in image_types and  not (f in self.out_list)
                ]
        return images[0:2]
