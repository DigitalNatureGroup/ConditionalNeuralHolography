...
class pgImageLoader:
    ...
    def __init__(self,distance,channel=None, batch_size=1,
                 image_res=(1080, 1920), homography_res=(880, 1600),
                 shuffle=True, vertical_flips=True, horizontal_flips=True,
                 idx_subset=None, crop_to_homography=False,start_dis=0.2,end_dis=0.5):
        data_path='/images/div2k/DIV2K_one'
