...
class DistnaceImageLoader:
    ...
    def __init__(self, data_path, channel=None, batch_size=1,
                 ...
                 idx_subset=None, crop_to_homography=False,start_dis=0.2,end_dis=0.2):
    ...
    def load_batch(self, images):
        ...
        return (ims,
                [dis for _, dis,_,_ in im_res_name],
    ...
    def load_image(self, filenum, *augmentation_states):
        ...
        return (torch.from_numpy(target_img).float(),
                input_res,distance,
